...
export const SOLAR_SYSTEM_DATA: CelestialBodyConfig[] = [
  ...
  },
  {
    ...
    data: EARTH_DATA,
    albedoUrl: `${TEXTURE_BASE}terra.jpg`,
    heightMapUrl: `${TEXTURE_BASE}terra_height.jpg`
  },
  {
    id: 'moon',
    name: 'LUNA',
    ...
    albedoUrl: `${TEXTURE_BASE}luna.jpg`,
    heightMapUrl: `${TEXTURE_BASE}luna_height.jpg`
  },
  {
    id: 'mars',
    name: 'MARS',
    ...
    albedoUrl: `${TEXTURE_BASE}mars.jpg`,
    heightMapUrl: `${TEXTURE_BASE}mars_height.jpg`
  },
  {
    id: 'belt',
    name: 'BELT',
  ...
  },
  {
    ...
    albedoUrl: `${TEXTURE_BASE}io.jpg`,
    heightMapUrl: `${TEXTURE_BASE}io_height.jpg`
  },
  {
    id: 'europa',
    name: 'EUROPA',
    ...
    albedoUrl: `${TEXTURE_BASE}europa.jpg`,
    heightMapUrl: `${TEXTURE_BASE}europa_height.jpg`
  },
  {
    id: 'ganymede',
    name: 'GANYMEDE',
    ...
    albedoUrl: `${TEXTURE_BASE}ganymede.jpg`,
    heightMapUrl: `${TEXTURE_BASE}ganymede_height.jpg`
  },
  {
    id: 'callisto',
    name: 'CALLISTO',
    ...
    albedoUrl: `${TEXTURE_BASE}callisto.jpg`,
    heightMapUrl: `${TEXTURE_BASE}callisto_height.jpg`
  },
  {
    id: 'saturn',
    name: 'SATURN',
